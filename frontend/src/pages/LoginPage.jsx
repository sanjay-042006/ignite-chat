        ...
        <div className="min-h-screen bg-background grid lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center items-center p-6 sm:p-12">
              ...
              group-hover:bg-indigo-500/30 transition-colors"
                            ...
                            <p className="text-muted-foreground text-sm">Sign in to your IgniteChat account.</p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <p className="text-sm text-muted-foreground">
                            ...
                            <Link to="/signup" className="text-indigo-500 hover:text-indigo-400 font-semibold underline-offset-4 hover:underline">
                                Create account
                            </Link>
                        </p>
                    </div>
            ...
            <div className="hidden lg:flex items-center justify-center p-12 relative overflow-hidden bg-indigo-950/20">
                ...
                <div className="relative z-10 text-center space-y-8 glass p-12 rounded-3xl max-w-lg border-white/10">
                    <h2 className="text-4xl font-extrabold bg-gradient-to-br from-white to-gray-400 bg-clip-text text-transparent">Welcome back to IgniteChat.</h2>
                    <p className="text-gray-300 text-lg">
                        Resume your conversations, reconnect with friends, and practice your language skills.
                    </p>
                </div>
                {/* Decorative blur blobs */}
                <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-indigo-500/30 rounded-full blur-[100px] -z-10" />
                <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-purple-500/30 rounded-full blur-[100px] -z-10" />
            </div>
        </div>
    );
};
